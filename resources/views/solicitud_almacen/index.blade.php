        ...
        <div class="card-body">
            ...
            <div class="container">
                <div class="card-title text-xl text-gray-900 leading-tight">
                    <h2>{{ __('Solicitudes de Pedidos de Jefe de Dependencia') }}</h2>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class='text-center'>
                                                <div class='btn-group'>
                                                    <a href="{{ route('solicitud_almacen.show', $solicitud->id) }}" class="btn-circle btn-primary">
                                                        <i class="fa-solid fa-eye"></i></a>
                                                    &nbsp;
                                                    @hasanyrole('Jefe de Almacen|Administrador')
                                                    @if($solicitud->estado == 'pendiente')
    ...
    $(document).ready(function() {
        ...
        $('.approve-btn').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '{{ url("solicitud_almacen/approve") }}/' + id;
                }
            });
        });
        ...
        $('.reject-btn').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '{{ url("solicitud_almacen/reject") }}/' + id;
                }
            });
        });
    });
