...
<body>
  <div class="container">
    ...
    <div class="form-group">
      ...
      <input id="dependencia" type="text" value="{{ optional($solicitud->unidad->dependencia)->nombre }}" readonly style="width: 70%;">
    </div><br>

    <div class="box">
      TIPO DE REQUERIMIENTO: {{ optional($solicitud->tiporequerimiento)->descripcion }}
    </div>
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{ optional($producto->unidadMedida)->descripcion }}</td>
    ...
    <div class="signatures">
      <div class="signature">
        {{ optional($solicitud->unidad->dependencia)->nombre }}
        <div class="signature-line">DEPENDENCIA SOLICITANTE<br>FIRMA Y SELLO</div>
      </div>
      <div class="signature">
        {{ optional($solicitud->solicitud_unidad)->descripcion }}
