                    ...
                    <div class="col-lg-12 text-gray-900">
                        <form method="POST" action="{{ route('unidades.update', $unidad->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('descripcion') is-invalid @enderror" minlength="5" name="descripcion" id="descripcion" class="form-control" value=" {{ old('descripcion', $unidad->descripcion) }}" required>
                                @error('descripcion')
                            ...
                            <div class="form-group">
                                ...
                                <select name="dependencia_id" id="dependencia_id" class="form-control" required>
                                    ...
                                    <option value="{{ $dependencia->id }}" {{ $unidad->dependencia_id == $dependencia->id ? 'selected' : '' }}>
                                        {{ $dependencia->nombre }}
                                    </option>
                                    @endforeach
                                </select>
