                        ...
                        <form method="POST" action="{{ route('personas.store') }}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" minlength="2" class="form-control @error('primer_nombre') is-invalid @enderror" id="primer_nombre" name="primer_nombre" value="{{ old('primer_nombre') }}" required autofocus>
                                    @error('primer_nombre')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" minlength="5" class="form-control @error('apellido_paterno') is-invalid @enderror" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" minlength="5" class="form-control @error('apellido_materno') is-invalid @enderror" id="apellido_materno" name="apellido_materno" value="{{ old('apellido_materno') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" minlength="9" id="telefono" name="telefono" class="form-control" placeholder="987654321">
                                    </div>
                                    @error('telefono')
                                ...
                                <div class="form-group">
                                    ...
                                    <input minlength="8" type="text" class="form-control @error('numero_documento') is-invalid @enderror" id="numero_documento" name="numero_documento" value="{{ old('numero_documento') }}" required>
                            ...
                            <br>
                            <div class="car-body">
                                <button type="submit" id="btnGuardar" class="btn btn-success">Crear</button>
