      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 text-gray-900">
            <form method="POST" action="{{ route('categoriaproductos.update', $categoriaProducto->id) }}">
              @csrf
              @method('PUT')

              <div class="form-group">
                <label for="descripcion" class="col-form-label">Nombre:</label>
                <input type="text" minlength="5" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" value="{{ old('descripcion', $categoriaProducto->descripcion) }}" required autofocus>
                @error('descripcion')
